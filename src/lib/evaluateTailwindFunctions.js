...
import { withAlphaValue } from '../util/withAlphaVariable.js'
...
function validatePath(config, path, defaultValue, opacityValue = undefined) {
  ...
  return {
    isValid: true,
    value: transformThemeValue(themeSection)(value, opacityValue),
  }
}
